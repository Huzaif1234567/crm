        ...
        <div class="navigation-menu">
            <div id ="navigation">
                <div class="navbar">
                    ...
                    <a class="a" href="ChangeUserPassword.php?id=<?php echo $_SESSION['id']?>">Change Password</a>
        ...
        <table class="paginated">
            ...
            <tbody>
                ...
                <tr>  
                    ...
                    <td>
                        <a href="responseformteam.php?id=<?php echo $res['id']?>" method="post">Write Response</a><br><br>
                        <a href="responseteam1.php?cnumber=<?php echo $res['cnumber']?>" method="post">View Response</a>
                    </td>
                </tr>
                <?php
                }

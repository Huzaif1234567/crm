...
<div id ="navigation">
<div class="navbar">
 <a class="a" href="Leadformadmin.php">Upload Lead</a>
  <a class="a" href="LeadFileadmin.php">Upload a File</a>
  <a class="a" href="logoutadmin.php">logout</a>
</div>
</div>
</div>
</div>
...
$sql = "SELECT * FROM leadform WHERE type='{$type}' AND platform='{$platform}' AND campaign='{$campaign}'  ";
...
<td><a href="assignleadadmin.php?id=<?php echo $res['id']?>"><img src="assign.png" width="20px" height= "20px" alt=""/></td>

...
$sql = "SELECT * FROM leadformmanager WHERE Date='{$date}' AND type='{$type}' AND platform='{$platform}' AND campaign='{$campaign}'  ";
...
$query = "SELECT name from weeklyroster WHERE $day='On' AND manager='$manager' AND role='Team-Lead'";

...
<div id ="navigation">
<div class="navbar">
  <a class="a" href="logoutdistributor.php">logout</a>
</div>
</div>
</div>
</div>
...
$sql = "SELECT * FROM leadformdistributor WHERE Date='{$date}' AND type='{$type}' AND platform='{$platform}' AND campaign='{$campaign}'  ";

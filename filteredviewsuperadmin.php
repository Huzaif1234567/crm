...
<a class="a" href="Leadformadminsuper.php">Upload Lead</a>
  ...
  <a class="a" href="ChangeUserPasswordSuperAdmin.php?id=<?php echo $_SESSION['id']?>">Change Password</a>
  <a class="a" href="ManageAccounts.php">Manage Accounts</a>
  <a class="a" href="logoutadminsuper.php">logout</a>
</div>
</div>
</div>
</div>
...
<td><a href="responseteam1super.php?cnumber=<?php echo $res['cnumber']?>" method="post">View Response</a</td>
</tr>
<?php
}
	}

...
<div id ="navigation">
<div class="navbar">
  <a class="a" href="logoutteamlead.php">logout</a>
</div>
</div>
</div>
</div>
...
$sql = "SELECT * FROM leadformteamlead WHERE type='{$type}' AND platform='{$platform}' AND campaign='{$campaign}'  ";
...
$query = "SELECT name from weeklyroster WHERE $day='On' AND manager='$manager' AND role='Team-Member'";
